...
public class CoronaVaccine implements Serializable {
	...
	public CoronaVaccine() {
		System.out.println("CoronaVaccine zero param constructor called");
		System.out.println("Hibernate internally uses default zero param constructor during object creation");
	}
