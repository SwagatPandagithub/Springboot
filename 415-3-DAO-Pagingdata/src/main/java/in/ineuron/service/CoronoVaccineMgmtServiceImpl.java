...
public class CoronoVaccineMgmtServiceImpl implements ICoronaVaccineMgmtService {
	...
	@Override
	public Iterable<CoronaVaccine> fetchDetailsByPageNo(int pageNo, int pageSize, boolean asc, String... propperties) {
		
		Pageable pageable = PageRequest.of(pageNo, pageSize, asc?Direction.ASC:Direction.DESC, propperties);
